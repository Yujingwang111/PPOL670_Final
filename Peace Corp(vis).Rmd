...
Firstly, we make a visual analysis of the number of crimes committed by DC. According to the figure, we can find that compared with 2019, the number of crimes in 2020 has decreased significantly, which has a certain relationship with the COVID-19.
...
```
In this heat map, we can more accurately see that 19-23 o'clock on Friday is the high incidence period of property crime. In addition, 22 o'clock on Tuesday is also the high incidence period of crime.
